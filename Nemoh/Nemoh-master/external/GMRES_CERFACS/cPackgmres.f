...
*
     ...
     &                              icntl(7)
           write(ihist,'(A27,E16.2)') 'Tolerance for convergence: ', 
     &                                cntl(1) 
* 
           write(ihist,'(A53)') 
     ...
     &       '    the residual is normalised by ||b||'
             ...
             write(ihist,1) sA,sb
1     format('    the residual is normalised by         ',E16.2,
     &       ' * ||x|| + ',E16.2)
           endif
           sPA      = cntl(4)
           sPb      = cntl(5)
...
4     format('    the preconditioned residual is normalised by ', E16.2,
     &        ' * ||(P2)y|| + ',E16.2)
           endif
*
...
*
      if (bn.eq.DZRO) then
        ...
        bea = DZRO
        be  = DZRO
        write(ihist,'(I5,11x,E16.2,$)') jH,bea
        write(ihist,'(7x,E16.2)') be
        info(1)  = 0
        info(2)  = 0
        rinfo(1) = DZRO
        rinfo(2) = DZRO
...
1000  format(I5,11x,E16.2,7x,E16.2)
         endif
*
       endif
*
...
1010  format('B.E. on the preconditioned system:   ',E16.2)
1011  format('B.E. on the unpreconditioned system: ',E16.2)
           endif
           info(2) = iterOut*m+jH
           if (ihist.ne.0) then
